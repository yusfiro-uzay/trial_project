...
#ifdef _MSC_VER // Visual Studio derleyicisi için
__declspec(align(16))
union branchtab27 { unsigned char c[32]; } Branchtab27[2];
#else // GCC veya Clang için
union branchtab27 { unsigned char c[32]; } Branchtab27[2] __attribute__((aligned(16)));
#endif
static int Init = 0;
